...
#parser.add_argument('-fraction', type=float, default=0.25, help='Fraction for annulus radius in hollow ball optimizer')
...
if not kwargs["better_fit"]:
    model = PULSE(cache_dir=kwargs["cache_dir"],model_name=kwargs["model_name"],num_w_layers=kwargs["num_w_layers"],mask_type=kwargs["mask_type"])
else:
    model = PULSE_bf(cache_dir=kwargs["cache_dir"],model_name=kwargs["model_name"],num_w_layers=kwargs["num_w_layers"],mask_type=kwargs["mask_type"])
