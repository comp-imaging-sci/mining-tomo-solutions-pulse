...
parser.add_argument('-C', type=float, default=0.01, help='Cumulative probability to decide cut-off for norms of whitened variables')
...
model = PULSE_pp(cache_dir=kwargs["cache_dir"],model_name=kwargs["model_name"],num_w_layers=kwargs["num_w_layers"],mask_type=kwargs["mask_type"])
