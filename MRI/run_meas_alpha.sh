...
LEARNING_RATE=0.4
P=1e-5
LAMBDA=1e-4 # Euclidean loss hyperparameter
...
# Save only final
python -u run_pp.py -sigma $SIGMA -p $P -input_dir $INPUT_DIR -output_dir $OUTPUT_DIR -duplicates $DUPLICATES -loss_str $LOSS_STR -loss_domain meas -eps $EPS \
