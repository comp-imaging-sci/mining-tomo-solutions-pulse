...
class PULSE_alpha_kl(torch.nn.Module):
    ...
    def forward(self, ref_im,
        ...
        loss_builder = LossBuilder(ref_im, loss_str, loss_domain, self.I, self.n_angles, eps).cuda()
