...
#EPS=1e-4
LEARNING_RATE=0.4
LAMBDA=1e-10 # GEOCROSS loss hyperparameter
...
OUTPUT_DIR=/shared/aristotle/MRI/sbhadra/pulse_null_functions/runs/noisy_snr_${SNR}_meas_AR/${MASK_TYPE}/bf_lr_${LEARNING_RATE}_geocross_$LAMBDA
DUPLICATES=5
...
python -u run.py -input_dir $INPUT_DIR -output_dir $OUTPUT_DIR -duplicates $DUPLICATES -loss_str $LOSS_STR -loss_domain meas -eps 1 -better_fit \
