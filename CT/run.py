...
parser.add_argument('-num_w_layers', type=int, required=True, default=16, help='Number of w layers')
parser.add_argument('-n_angles', type=int, default=60, help='Number of views in the fanbeam projector')
...
if not kwargs["better_fit"]:
    model = PULSE(cache_dir=kwargs["cache_dir"],model_name=kwargs["model_name"],num_w_layers=kwargs["num_w_layers"],n_angles=kwargs["n_angles"])
else:
    model = PULSE_bf(cache_dir=kwargs["cache_dir"],model_name=kwargs["model_name"],num_w_layers=kwargs["num_w_layers"],n_angles=kwargs["n_angles"])
