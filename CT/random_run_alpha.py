...
from PULSE_random_alpha import PULSE_random_alpha
...
parser.add_argument('-random_fraction', type=float, default=0.5, help='Fraction of measurements for random data fidelity computations')
parser.add_argument('-random_epochs', type=int, default=1000, help='Number of epochs to compute random data fidelity')
...
if not kwargs["better_fit"]:
    model = PULSE_random_alpha(cache_dir=kwargs["cache_dir"],model_name=kwargs["model_name"],num_w_layers=kwargs["num_w_layers"],I=kwargs["I"],n_proj=kwargs["n_proj"])
else:
