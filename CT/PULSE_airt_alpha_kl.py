...
class PULSE_airt_alpha_kl(torch.nn.Module):
    ...
    def __init__(self, cache_dir, model_name, num_w_layers, I, n_proj, better_fit=False, verbose=True):
        super(PULSE_airt_alpha_kl, self).__init__()
    ...
    def forward(self, ref_im,
        ...
        alpha_min_vals = pickle.load(open('no_bf_alpha_min.pkl','rb'))
        alpha_max_vals = pickle.load(open('no_bf_alpha_max.pkl','rb'))
